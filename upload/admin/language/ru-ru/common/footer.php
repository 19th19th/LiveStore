...
$_['text_display_errors'] = 'Внимание: показ ошибок PHP включён! Это не рекомендуется на рабочем сайте. <br> Чтобы отключить, установите SHOW_ERRORS = false в файлах config.php и admin/config.php.';